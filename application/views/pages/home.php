  <header>
    <div class="header-content">
      <div class="header-content-inner">
        ...
        <a href="#about" class="btn btn-primary btn-xl page-scroll">Daftar</a>
      </div>
    </div>
  </header>
      ...
      <div class="row">
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box">
            <i class="fa fa-4x fa-road wow bounceIn text-primary"></i>
            <h3>ROADSHOW</h3>
            <p class="text-muted">9 JANUARI- 21 JANUARI</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box">
            <i class="fa fa-4x fa-sign-in wow bounceIn text-primary" data-wow-delay=".1s"></i>
            <h3>PENDAFTARAN</h3>
            <p class="text-muted">13 JANUARI- 22 JANUARI</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box">
            <i class="fa fa-4x  fa-book  wow bounceIn text-primary" data-wow-delay=".2s"></i>
            <h3>TRY OUT DAN TALKSHOW</h3>
            <p class="text-muted">24 JANUARI</p>
          </div>
        </div>
        <div class="col-lg-3 col-md-6 text-center">
          <div class="service-box">
            <i class="fa fa-4x  fa-rss-square wow bounceIn text-primary" data-wow-delay=".3s"></i>
            <h3>PENGUMUMAN</h3>
            <p class="text-muted">FEBRUARI - MARET 2016</p>
          </div>
        </div>
      </div>
    </div>
